...
const prompt = require("prompt-sync")();
 ...
 function Calcula_notas (alumno) {
     this.practica= pedir_nota ("practica",10);
    this.teorica = pedir_nota ("teorica",40);
    this.problemas = pedir_nota ("problemas",50); 
    console.log (`La nota de ${alumno} es ${practica+teorica+problemas}`);
 }
 function pedir_nota (nota,porcentaje) {
    this.suma = Number(prompt(`Introduce la nota de ${nota}:`));
     return suma * porcentaje / 100;
 }
